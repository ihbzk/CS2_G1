<div class="max-w-screen-md mx-auto p-5 border-4 border-red-700 m-5">
    <div class="text-center">
        ...
        <h2 class="text-xl sm:text-2xl leading-normal font-bold tracking-tight text-black pt-2 pb-5">Recevoir un nouveau mot de passe</h2>
        <hr class="mb-3">
    </div>
    ...
    <div>
        <?php
            ...
            if($_SERVER['QUERY_STRING'] == "mailSended"){
                echo "Un mail de réinitialisation de mot de passe vous a été envoyé.";
            }
        ?>
    </div>
</div>