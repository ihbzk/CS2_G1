<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div class="text-center">
            <h1 class="text-xl sm:text-2xl leading-normal font-bold tracking-tight text-black pt-2 pb-5">Résultats de recherche</h1>
        </div>
        <div class="flex flex-wrap justify-center items-center">
            <?php if (!empty($productData)) : ?>
                ...
                <?php endforeach; ?>
            <?php else : ?>
                <h2 class="text-xl sm:text-lg leading-normal font-bold tracking-tight text-black pt-20 pb-5">Introuvable :/</h2>
                <p>Le nom du produit est peut-être erroné ou n'existe pas.</p>
            <?php endif; ?>
        </div>
    </div>
</div>