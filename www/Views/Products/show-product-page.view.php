    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        ...
        <div class="py-8">
            <?php if (isset($_SESSION['role'])) : ?>
                ...
                <?php else : ?>
                    <div class="text-center">
                    <h2 class="text-xl sm:text-2xl leading-normal font-bold tracking-tight text-black pt-2 pb-5 text-red-700"><a href="/login" class="text-purple-700 underline">Connectez-vous</a> pour inscire un commentaire</h2>
                    </div>
            <?php endif; ?>
