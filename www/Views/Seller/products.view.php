                    ...
                    <div class="w-full md:w-1/2 p-2">
                        <div class="bg-white shadow-lg hover:shadow-xl rounded-lg ">
                            ...
                            <div class="flex justify-center items-center px-2 pb-2">
                                <div class="w-1/2 p-2">
                                    <a href="products/page?id=<?= $product['id']; ?>" class="block w-full bg-red-700 hover:bg-red-800 text-white border-2 border-red-700 hover:border-red-800 px-3 py-2 rounded uppercase font-poppins font-medium text-center" aria-label="Voir le produit">
